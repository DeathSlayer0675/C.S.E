...
SUPPLY_CLOSET = Room("Supply Closet", None, None, "WEST_HALLWAY", None, None, None, None, None, None, None,
                     [crowbar, flashlight], None, "There's a flashlight on the wall "
...
SHOW_STAGE = Room("Show Stage", None, None, None, None, "DINING_AREA", None, None, None, None, None, None,
                  [Orc, Orc2, Orc4], "There are three animatronics standing here.")

BACKSTAGE = Room("Backstage", None, None, "DINING_AREA", None, None, None, None, None, None, None, None, Orc3,
